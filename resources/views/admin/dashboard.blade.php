        ...
        <div id="main">
            <div class="contentMain">
                <div class="container">
                    ...
                    <h2>Semoga Hari Kamu Biasa Aja. </h2>
...
<div class="modal-header">
            ...
            <form action="/management/aduan/edit/${$(e.relatedTarget).data('id')}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="p-3">
                    ...
                    <input type="text" class="form-control" id="status" name="status" placeholder="isi status " value="${$(e.relatedTarget).data('status')}">
                </div>
